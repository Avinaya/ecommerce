...
return(
   <div className="addReview">
       ...
       <div className="addReview-sub">
           <spa>Rate and Review:share details of your experience at this product.</spa>
       </div>
       <div className="addReview-product">
           ...
           <div className="addReview-reviewTitle">
               ...
               <div>
               <input type="text" value={reviewTitle} onChange={e=>setReviewTitle(e.target.value)} className="addReview-reviewTitle-input" placeholder="Add Review Title"/>
           ...
           <div className="addReview-review">
               <span>Review</span>
               <div>
               <input className="addReview-review-input1"
               type="text"
               value={review} 
               onChange={e => setReview(e.target.value)} placeholder="Add Review" required/>
