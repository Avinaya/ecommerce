    ...
    render(){
        ...
        <div className="login">
            ...
            <Link className="login-link" to="/">
                <span className="logos">Sapta</span><span className="logos-1">Bazar</span>
                </Link>
                <div className="login-items-account">
                    ...
                    <div className="login-items-account-entity">
                        ...
                        <Form className="login-items-account-entity-form"
            ...
            />
                    ...
                    <div className="extra">
                        ...
                        <a className="extra-click" href="/signup">Sign Up</a>
                    </div>
                </div>
            </div>
        </div>
